...
diary_montly_schema = extend_schema(
    description=(
        ...
        "해당 기간에 작성한 일기가 없으면 빈 배열을 반환합니다"
    ),
    summary="월간 일기 조회",
    tags=["일기"],
    examples=[
            ...
            value=[
                {
                    ...
                    "photos": [
                        {
                            "id": "67fa2bec-d2ba-411e-a0a6-9a9c8571d3c2",
                            "photo": "/media/2022/03/16/오늘의 사진.jpg",
                            "dairies": "5286792e-2ec5-44b4-8ebb-7445b717e60b",
                        },
                    ],
                    "content": "test",
                    "date": "2022-03-16",
