...
def cap(image_):
  train_captions = open('./weight4_train_captions.txt','r')
  ...
  encoder2.load_weights('/content/drive/MyDrive/SSAFY/encoder_model_weights4/encoder')

  decoder2 = RNN_Decoder(embedding_dim, units, vocab_size)

  decoder2.load_weights('/content/drive/MyDrive/SSAFY/decoder_model_weights4/decoder')
